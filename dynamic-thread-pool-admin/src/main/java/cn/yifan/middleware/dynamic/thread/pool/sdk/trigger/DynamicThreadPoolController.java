...
import cn.yifan.middleware.dynamic.thread.pool.sdk.entity.Response;
...
/**
 * @FileName DynamicThreadPoolController
 * @Description
 * @Author yifan
 * @date 2024-08-18 12:42
 **/
...
public class DynamicThreadPoolController {
    ...
    public Response<List<ThreadPoolConfigEntity>> queryThreadPoolList() {
        try {
            RList<ThreadPoolConfigEntity> cacheList = redissonClient.getList(RedisConstant.THREAD_POOL_CONFIG_LIST_KEY);
    ...
    public Response<Boolean> updateThreadPoolConfig(@RequestBody ThreadPoolConfigEntity request) {
        try {
            ...
            String key = String.format("%s:%s", RedisConstant.THREAD_POOL_CONFIG_UPDATE_TOPIC, request.getAppName());
